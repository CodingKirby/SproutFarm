...
public class IntroSceneManager : MonoBehaviour
{
    ...
    private IEnumerator MoveUIWithPlayer()
    {
        ...
        //float canvasCenterY = canvas.GetComponent<RectTransform>().rect.height / 2;
        ...
        while (elapsedTime < 2f)
        {
            ...
            {
                textToFollow.transform.position = new Vector3(canvasCenterX, canvasCenterY, textToFollow.transform.position.z);
